 ...
 *
 * 两个硬约束写在类名里：
 * - 封面容器用 2:3（ui.md §3.6、T-004 第 4 条），而封面资产是第 1 话第 1 页的
 *   3:4 页图（600×800）—— 容器比资产更瘦，所以 object-cover 会左右居中裁掉一点
 *   上下边缘，这是 D-012 的裁决：接入真实内容时再单独出 2:3 封面。图片按
 *   ImageRef 的宽高交给 next/image，加载前后容器高度不变，滚动时页面不跳；
